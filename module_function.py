...
def LGU_network(xi,w,Lambda):
    ...
    # ah9 = sigmoid(net[8],Lambda)
    # ah10 = sigmoid(net[9],Lambda)
    # ah11 = sigmoid(net[10],Lambda)
    # ah12 = sigmoid(net[10],Lambda)
    ah = np.asarray([ah1,ah2,ah3,ah4,ah5])#,ah6,ah7,ah8,ah9,ah10,ah11,ah12])
    ## Softmax Function: 
